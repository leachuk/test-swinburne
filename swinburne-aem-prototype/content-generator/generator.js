...
try {
  ...
  const parseFile = (configFilePath) => {
    console.log('222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222', configFilePath);
  ...
  const configSubDirectories = getDirectories(currentPath(configPath));
  configSubDirectories.forEach((configSubDirectory, index) => {
      parseFile(currentPath(`${configSubDirectory}/config.yml`));
  });
