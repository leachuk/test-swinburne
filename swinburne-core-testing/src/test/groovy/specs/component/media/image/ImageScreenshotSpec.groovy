...
//    @Unroll("Appearance of Component Variant: Default Empty in #viewport.label")
...
//    @Unroll("Appearance of Component Variant: Image Only Empty in #viewport.label")
...
//    @Unroll("Appearance of Component Variant: Card Empty in #viewport.label")
...
//    @Unroll("Appearance of Component Variant: Image Title and Description Empty in #viewport.label")
