...
class ContentBlockLockPublishSpec extends ComponentSpec {
    ...
    def "Functionality of Component Variant: Section with Background"() {
        ...
        assert $(selector).css("background-image").indexOf("/content/swinburne-showcase/en/component/layout/contentblocklock/_jcr_content/article/par/contentblocklock8/bgimage.img.png/0.png") > 0
