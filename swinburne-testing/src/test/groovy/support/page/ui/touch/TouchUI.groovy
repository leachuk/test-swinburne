...
//    }
    ...
    def closeDialog(String path) {
        return Window("Granite.author.DialogFrame.currentFloatingDialog.first().find(\".cq-dialog-cancel\").click()", false)
    }
    ...
    def execDialog(String path, String action) {
        //CQ.utils.WCM.getDialogs()["editdialog-/content/swinburne-showcase/en/component/layout/contentblocklock/jcr:content/article/par/contentblocklock1"].find("name","permissionCheckTabAccessCheck")
        throw new Error("not implemented")
